...
| **Agent QA** | https://github.com/vostride/agent-qa | Three Agent Skills for authoring tests, debugging failures, and triaging results, backed by a natural-language web/mobile QA CLI and MCP server; source-available under FSL-1.1-ALv2 |
